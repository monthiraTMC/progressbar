...
class CustomProgressAnimationView(context: Context, attrs: AttributeSet) : LinearLayout(context, attrs) {
    ...
    private fun playAnimation() {
        ...
        animatorSet = AnimatorSet().apply {
            ...
            val translateAnimator01 = createTranslationAnimator(view.progress_circle01, TRANSLATION_Y, TRANSLATION_VALUE)
            val translateAnimator02 = createTranslationAnimator(view.progress_circle02, TRANSLATION_X, TRANSLATION_VALUE)
            val translateAnimator03 = createTranslationAnimator(view.progress_circle03, TRANSLATION_X, -TRANSLATION_VALUE)
            val translateAnimator04 = createTranslationAnimator(view.progress_circle04, TRANSLATION_Y, -TRANSLATION_VALUE)
            playTogether(rotationAnimator,
                translateAnimator01,
                translateAnimator02,
                translateAnimator03,
                translateAnimator04)
    ...
    private fun createTranslationAnimator(imageView: ImageView?, translationType: String, traslationValue: Float): Animator? {
